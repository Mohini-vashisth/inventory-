...
- **GradeOption** / **SizeOption** — admin-managed lists of valid grades/sizes shown as tap-to-pick options on the Gate Entry form's lot rows (`/gate-entry/`); keeps the picker in sync without a code change
